...
(function (State) {
    ...
    State[State["HEADING"] = 1] = "HEADING";
    State[State["CODE_FENCE"] = 2] = "CODE_FENCE";
    State[State["CODE_CONTENT"] = 3] = "CODE_CONTENT";
    State[State["TABLE_HEADER"] = 4] = "TABLE_HEADER";
    State[State["TABLE_ROW"] = 5] = "TABLE_ROW";
    State[State["LIST_ITEM"] = 6] = "LIST_ITEM";
    State[State["FRONTMATTER"] = 7] = "FRONTMATTER";
    State[State["BLOCKQUOTE"] = 8] = "BLOCKQUOTE";
    State[State["HORIZONTAL_RULE"] = 9] = "HORIZONTAL_RULE";
    State[State["HTML_COMMENT"] = 10] = "HTML_COMMENT";
    State[State["BLANK_LINE"] = 11] = "BLANK_LINE";
})(State || (State = {}));
...
// ─── Inline Stripper ──────────────────────────────────────────────────────────
function stripInline(text, stats) {
    let result = text;
